...
public class MobClassVideoBase extends BasisActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		shareCourseTitleUrl = "http://class."+Constant.IYBHttpHead()+"/m.jsp?id=" + TitleId;
		shareCourseTitleImageUrl = "http://static3."+Constant.IYBHttpHead()+"/resource/categoryIcon/" + PackId + ".png";
	...
	public void initStudyRecord() {
		...
		studyRecordInfo.appName = Constant.APPType;
		...
		if (UserInfoManager.getInstance().isLogin()) {
			studyRecordInfo.uid = String.valueOf(UserInfoManager.getInstance().getUserId());
		} else {
...
//			 oks.setUrl("http://class."+Constant.IYBHttpHead+"/m.jsp?id=2");
			...
			switch (msg.what) {
				...
				case 10:
					ClientSession.Instace().asynGetResponse(
							new AddCreditsRequest(String.valueOf(UserInfoManager.getInstance().getUserId()), TitleId),
