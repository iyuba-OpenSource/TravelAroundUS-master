...
public class OrderGenerateRequest extends BaseJsonObjectRequest {
    ...
    private static final String oldApi = "http://vip."+Constant.IYBHttpHead()+"/chargeapi.jsp?";
    private static final String newApi = "http://vip."+Constant.IYBHttpHead()+"/chargeapinew.jsp?";
