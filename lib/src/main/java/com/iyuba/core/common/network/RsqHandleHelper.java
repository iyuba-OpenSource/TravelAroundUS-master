...
//			String agent = context.getResources().getString(R.string.minName) + "/"
//					+ context.getResources().getString(R.string.minVer) + " "
//					+ context.getResources().getString(R.string.runEnv_name) + "/"
//					+ Build.VERSION.RELEASE;
			String agent = "SurfingNearby/2.0 Android/" + Build.VERSION.RELEASE;
			httpPost.addHeader("Client-Agent", agent);
			httpPost.addHeader("ParamSet",
					"ssite=10");
//			"ssite=" + context.getResources().getString(R.string.ssite_code));
