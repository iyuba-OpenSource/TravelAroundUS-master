...
//		public void viewClick(String url);
	...
	public RollViewPager(Context context,final List<View> dot_List,OnViewClickListener onViewClickListener) {
		super(context);
...
//			GitHubImageLoader.Instance(context).setPic(imgUrlList.get(position),
