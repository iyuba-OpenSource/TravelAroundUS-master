...
/**
 * @title: 走遍美国-后台播放关闭接收器
 * @date: 2023/10/27 13:18
 * @author: liang_mu
 * @email: liang.mu.cn@gmail.com
 * @description:
 */
public class TravelBgPlayCloseReceiver extends BroadcastReceiver {
...
//        }
        ...
        //直接退出app
        EventBus.getDefault().post(new TravelBgPlayEvent(TravelBgPlayEvent.existApp));
    }
}
