...
//            n.icon = android.R.drawable.stat_sys_download_done;
            ...
            n.contentIntent = PendingIntent.getBroadcast(mContext, 0, intent, 0);
            intent = new Intent(com.iyuba.core.downloadprovider.ncpt.downloads.Constants.ACTION_HIDE);
            intent.setClassName(mContext.getPackageName(),
                    com.iyuba.core.downloadprovider.ncpt.downloads.DownloadReceiver.class.getName());
            intent.setData(contentUri);
