package com.iyuba.core.downloadprovider.ncpt.downloads;
...
import com.iyuba.core.downloadprovider.ncpt.downloads.providers.DownloadManager;
import com.iyuba.core.downloadprovider.ncpt.downloads.providers.DownloadManager.Request;
...
public class DownloadManagerProxy {
	...
	public boolean addDownload(int voaId, String url) {
		if(idMap.get(voaId) != null) {
			...
			request.setDestinationInExternalPublicDir("/"+ "/iyuba/"+Constant.APPType +"2/res", "/");
			request.setDescription(Constant.APPType + "2");
	...
	public boolean addDownloadAll(int voaId, String urlZip,String urlVideo) {
		if(idMap.get(voaId) != null) {
			...
			requestZip.setDestinationInExternalPublicDir("/"+ "/iYuba/"+Constant.APPType +"2/res", "/");
			requestZip.setDescription(Constant.APPType + "2");
			...
			requestVideo.setDestinationInExternalPublicDir("/"+ "/iYuba/"+Constant.APPType +"/res", "/");
			requestVideo.setDescription(Constant.APPType);
