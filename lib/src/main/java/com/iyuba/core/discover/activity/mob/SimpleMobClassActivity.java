...
//		MobClassContentUrl = "http://class."+Constant.IYBHttpHead()+"/getClass.iyuba?protocol=10102&id="
//				+ PackId
//				+ "&type=2&sign="
...
//
//							if (AccountManager.Instance(mContext)
//									.checkUserLogin()) {
//								if (CostedPrice
...
//
//				MobClassPayedRecordUrl = "http://app."+Constant.IYBHttpHead()+"/pay/apiGetPayRecord.jsp?userId="
...
//
//		MobClassMbTextUrl = "http://class."+Constant.IYBHttpHead()+"/getClass.iyuba?protocol=10003&id="
