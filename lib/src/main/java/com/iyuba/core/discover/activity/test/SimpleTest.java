...
public class SimpleTest extends BasisActivity {
	...
	private void initData() {
		...
		if (curTestType.equals(mContext.getString(R.string.cet_4))) {
			getTestUrl = "http://apps."+Constant.IYBHttpHead()+"/newcet/cetTest.jsp?level=4&year=";
			downloadAppUrl += "com.iyuba.cet4";
			type = 0;
		} else if (curTestType.equals(mContext.getString(R.string.cet_6))) {
			getTestUrl = "http://apps."+Constant.IYBHttpHead()+"/newcet/cetTest.jsp?level=6&year=";
			downloadAppUrl += "com.iyuba.cet6";
			type = 1;
		} else if (curTestType.equals(mContext.getString(R.string.toeic))) {
			getTestUrl = "http://apps."+Constant.IYBHttpHead()+"/voa/titleApi.jsp?maxid=0&pageNum=20&pages=1&category=csvoa&type=json";
			downloadAppUrl += "com.iyuba.toeiclistening";
			type = 2;
		} else if (curTestType.equals(mContext.getString(R.string.toelf))) {
			getTestUrl = "http://apps."+Constant.IYBHttpHead()+"/minutes/titleApi.jsp?type=android&format=json&pages=1&parentID=2&pageNum=20&maxid=0";
			downloadAppUrl += "com.iyuba.toelflistening";
			type = 3;
		} else if (curTestType.equals(mContext.getString(R.string.jlpt1))) {
			getTestUrl = "http://apps."+Constant.IYBHttpHead()+"/minutes/titleApi.jsp?type=android&format=json&pages=1&parentID=1&pageNum=20&maxid=0";
			downloadAppUrl += "com.iyuba.JLPT1Listening";
			type = 4;
		} else if (curTestType.equals(mContext.getString(R.string.jlpt2))) {
			getTestUrl = "http://apps."+Constant.IYBHttpHead()+"/voa/titleApi.jsp?maxid=0&pageNum=20&pages=1&type=json&parentID=200";
			downloadAppUrl += "com.iyuba.JLPT2Listening";
			type = 5;
		} else if (curTestType.equals(mContext.getString(R.string.jlpt3))) {
			getTestUrl = "http://apps."+Constant.IYBHttpHead()+"/minutes/titleApi.jsp?type=android&format=json&pages=1&parentID=3&pageNum=20&maxid=0";
