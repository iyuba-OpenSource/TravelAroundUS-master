...
public class BlogActivity1 extends THSActivity implements
	...
	private void prepareMessage() {
		//String imagePath = ImageOperation.getSharePicPath(String.valueOf(DataManager.Instance().blogContent.blogid));
		...
		String text = "#爱语吧# "+DataManager.Instance().blogContent.username+"《"
				...
				+ " [http://blog."+Constant.IYBHttpHead()+"/GetBlogText?flag=1&uid=928&blog.blogid=" + DataManager.Instance().blogContent.blogid
				+ " ]"+" @爱语吧";
		String chinese = "";
	...
	private void initVideoPlay() {
		...
		//	videoPlayer.playUrl(Constant.VIDEO_ADD+DataManager.Instance().blogContent.mp3path);
		}
