...
public class SimpleNews extends BasisActivity {
	...
	private void initData() {
		...
		if (curNewsType.equals(mContext.getString(R.string.voa_speical))) {
			getTitleUrl = "http://apps."+Constant.IYBHttpHead()+"/voa/titleApi.jsp?maxid=0&pageNum=20&pages=1&type=json";
			downloadAppUrl += "com.iyuba.voa";
			lesson = "VOA慢速英语";
			shareUrl = "http://voa."+Constant.IYBHttpHead()+"/audioitem_special_";
		} else if (curNewsType.equals(mContext.getString(R.string.voa_cs))) {
			getTitleUrl = "http://apps."+Constant.IYBHttpHead()+"/voa/titleApi.jsp?maxid=0&pageNum=20&pages=1&category=csvoa&type=json";
			downloadAppUrl += "com.iyuba.CSvoa";
			lesson = "VOA常速英语";
			shareUrl = "http://voa."+Constant.IYBHttpHead()+"/audioitem_stardard_";
		} else if (curNewsType.equals(mContext.getString(R.string.voa_video))) {
			getTitleUrl = "http://apps."+Constant.IYBHttpHead()+"/voa/titleApi.jsp?maxid=0&pageNum=20&pages=1&category=csvoa&type=json";
			downloadAppUrl += "com.iyuba.VoaVideo";
			lesson = "VOA英语视频";
			shareUrl = "http://voa."+Constant.IYBHttpHead()+"/videoitem_video_";
		} else if (curNewsType.equals(mContext.getString(R.string.voa_bbc))) {
			getTitleUrl = "http://apps."+Constant.IYBHttpHead()+"/minutes/titleApi.jsp?type=android&format=json&pages=1&parentID=2&pageNum=20&maxid=0";
			downloadAppUrl += "com.iyuba.bbcws";
			lesson = "BBC职场英语";
			shareUrl = "http://bbc."+Constant.IYBHttpHead()+"/BBCItem_2_";
		} else if (curNewsType.equals(mContext.getString(R.string.voa_bbc6))) {
			getTitleUrl = "http://apps."+Constant.IYBHttpHead()+"/minutes/titleApi.jsp?type=android&format=json&pages=1&parentID=1&pageNum=20&maxid=0";
			downloadAppUrl += "com.iyuba.bbc";
			lesson = "BBC六分钟英语";
			shareUrl = "http://bbc."+Constant.IYBHttpHead()+"/BBCItem_1_";
		} else if (curNewsType.equals(mContext.getString(R.string.voa_ae))) {
			getTitleUrl = "http://apps."+Constant.IYBHttpHead()+"/voa/titleApi.jsp?maxid=0&pageNum=20&pages=1&type=json&parentID=200";
			downloadAppUrl += "com.iyuba.AE";
			lesson = "美语怎么说";
			shareUrl = "http://voa."+Constant.IYBHttpHead()+"/videoitem_meiyu_";
		} else if (curNewsType.equals(mContext.getString(R.string.voa_bbcnews))) {
			getTitleUrl = "http://apps."+Constant.IYBHttpHead()+"/minutes/titleApi.jsp?type=android&format=json&pages=1&parentID=3&pageNum=20&maxid=0";
			downloadAppUrl += "com.iyuba.bbcinone";
			lesson = "BBC新闻";
			shareUrl = "http://bbc."+Constant.IYBHttpHead()+"/BBCItem_3_";
		} else if (curNewsType.equals(mContext.getString(R.string.voa_word))) {
			getTitleUrl = "http://apps."+Constant.IYBHttpHead()+"/voa/titleApi.jsp?maxid=0&pageNum=20&pages=1&type=json&parentID=10";
			downloadAppUrl += "com.iyuba.WordStory";
			lesson = "VOA单词故事";
			shareUrl = "http://voa."+Constant.IYBHttpHead()+"/audioitem_special_";
		} else if (curNewsType.equals(mContext.getString(R.string.voa_music))) {
			getTitleUrl = "http://apps."+Constant.IYBHttpHead()+"/afterclass/getSongList.jsp?maxId=0&pageNum=1&pageCounts=20&type=json";
			downloadAppUrl += "com.iyuba.music";
			lesson = "听歌学英语";
			shareUrl = "http://music."+Constant.IYBHttpHead()+"/play.jsp?SongId=";
		} else if (curNewsType.equals(mContext.getString(R.string.voa_ted))) {
			getTitleUrl = "http://apps."+Constant.IYBHttpHead()+"/voa/titleTed2.jsp?maxid=0&pageNum=20&pages=1&type=json";
			downloadAppUrl += "com.iyuba.TEDVideo";
			lesson = "TED英语演讲";
			shareUrl = "http://app."+Constant.IYBHttpHead()+"";
		}
					...
					public void finish(BaseHttpResponse bhr) {
						...
						if (curNewsType.equals(mContext
							...
							for (CommonNews commonNews : newsArrayList) {
								commonNews.picUrl = "http://staticvip."+Constant.IYBHttpHead()+"/images/song/"
										+ commonNews.picUrl;
							}
						}
