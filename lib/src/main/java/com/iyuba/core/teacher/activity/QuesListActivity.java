...
public class QuesListActivity extends ListActivity implements
	...
	public void initWidget() {
		qt1 = (Spinner) findViewById(R.id.qt1);
		qt2 = (Spinner) findViewById(R.id.qt2);
		...
		qt1.setSelection(qtype1);
		qt2.setSelection(qtype2);

		qt1.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
				...
				Log.e("iyuba", arg2 + "");
				ConfigManager.Instance().putInt("qtype1", arg2);
				getHeaderData();
			}
		...
		qt2.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
				...
				Log.e("iyuba", arg2 + "");
				ConfigManager.Instance().putInt("qtype2", arg2);
				getHeaderData();
			}
		...
		quesListview = getListView();// (ListView)
										// findViewById(R.id.ques_listview);
		...
		quesListview.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
				...
				if (quesList.get(arg2).uid.equals(String.valueOf(UserInfoManager.getInstance().getUserId()))) {
		...
		quesListview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				// QuestionManager.getInstance().question.qid =
				// quesList.get(arg2).qid;
