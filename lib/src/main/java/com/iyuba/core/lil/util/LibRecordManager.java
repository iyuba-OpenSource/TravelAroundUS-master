...
public class LibRecordManager {
    ...
    public LibRecordManager(File file, ImageView view) {
        this.file = file;
        this.view = view;
    }

    public LibRecordManager(File file) {
        this.file = file;
    }
...
//            }
    ...
    public double getVolume(){
        ...
        if (ratio > 1){
            Log.d("分贝显示", "getVolume: --"+ratio+"--"+Math.log10(ratio)+"--"+20 * Math.log10(ratio));
