 ...
 * @description:
 */
public interface LibAdService {
    public static final int FLAG_SPLASH = 1;//开屏广告
    public static final int FLAG_BANNER = 4;//banner广告


    //广告接口-1是开屏、2是信息流、4是banner
    //http://dev.iyuba.cn/getAdEntryAll.jsp?uid=0&appId=230&flag=1
    @GET()
    Observable<List<Ad_result>> getAdInfo(@Url String url,
    ...
    @GET()
    Observable<Ad_reward_vip> getAdRewardVip(@Url String url,
                                             @Query("uid") int userId,
                                             @Query("appid") int appId,
                                             @Query("timeStr") long time,
                                             @Query("sign") String sign);
    ...
    Observable<Ad_clock_submit> submitAdData(@Url String url,
                                             ...
                                             @Query("uid") int userId,
                                             @Query("package_fix") String packageName,
                                             @Query("os") int os,
