package com.iyuba.core.lil.user;
...
import com.iyuba.core.lil.bean.LocalUserBean;
...
import com.iyuba.core.lil.user.util.UserInfoErrorMsgUtil;
import com.iyuba.core.lil.util.LibBigDecimalUtil;
import com.iyuba.core.lil.util.LibGsonUtil;
...
public class UserInfoManager {
    ...
    public String getUserPic(){
        ...
        return "http://api."+ Constant.IYBHttpHead2()+"/v2/api.iyuba?protocol=10005&uid=" + getUserId() + "&size=big";
    }
    ...
    private void refreshUserInfo(int userId,User_info info){
        ...
        String extraMergeUrl = "http://" + Constant.IYBHttpHead() + ":9001/test/merge/";
    ...
    public void getRemoteUserInfo(int userId, UserinfoCallbackListener listener){
        destroyUserInfo();
        LessonRemoteManager.getUserInfo(userId)
    ...
    public void postRemoteAccountLogin(String account, String password, UserinfoCallbackListener listener){
        destroyAccountLogin();
        LessonRemoteManager.loginByAccount(account, password)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
