...
import com.iyuba.concept2.adapter.RankFragmentListAdapter;
import com.iyuba.concept2.protocol.GetRankListenInfoRequest;
import com.iyuba.concept2.protocol.GetRankListenInfoResponse;
import com.iyuba.concept2.protocol.GetRankReadInfoRequest;
import com.iyuba.concept2.protocol.GetRankReadInfoResponse;
import com.iyuba.concept2.protocol.GetRankSpeakInfoRequest;
import com.iyuba.concept2.protocol.GetRankSpeakInfoResponse;
import com.iyuba.concept2.protocol.GetRankStudyInfoRequest;
import com.iyuba.concept2.protocol.GetRankStudynfoResponse;
import com.iyuba.concept2.protocol.GetRankTestInfoRequest;
import com.iyuba.concept2.protocol.GetRankTestInfoResponse;
...
//                        Toast.makeText(Main.this,"输入的是字母", Toast.LENGTH_SHORT).show();
                ...
                case 4:
                    ...
                    break;
                case 5:
                    CustomToast.showToast(mContext, "与服务器连接异常，请稍后再试", 1000);
                    break;
                case 6:
            ...
            case "阅读":
                ...
                ExeProtocol.exe(new GetRankReadInfoRequest(uid, type, start, total), new ProtocolResponse() {
                    ...
                    public void finish(BaseHttpResponse bhr) {
                        ...
                        String r_frag_siteUrl = "http://m."+Constant.IYBHttpHead()+"/i/getRanking.jsp?uid=" + uid + "&appId=" + Constant.APPID + "&sign=" + MD5.getMD5ofStr(uid + "ranking" + Constant.APPID)
...
//                        handler.sendEmptyMessage(5);
            ...
            case "听力":
                ...
                ExeProtocol.exe(new GetRankListenInfoRequest(uid, type, start, total, mode), new ProtocolResponse() {
                    ...
                    public void finish(BaseHttpResponse bhr) {
                        ...
                        String l_frag_siteUrl = "http://m."+Constant.IYBHttpHead()+"/i/getRanking.jsp?uid=" + uid + "&appId=" + Constant.APPID + "&sign=" + MD5.getMD5ofStr(uid + "ranking" + Constant.APPID)
            ...
            case "口语":
                ...
                mHanlder.sendEmptyMessage(1);
                String topic = "familyalbum", topicid = "0", shuoshuotype = "4";
                ExeProtocol.exe(new GetRankSpeakInfoRequest(uid, type, start, total, topic, topicid, shuoshuotype), new ProtocolResponse() {
                    ...
                    public void finish(BaseHttpResponse bhr) {
                        ...
                        Log.e(TAG, "finish: "+response.toString() );
                        mHanlder.sendEmptyMessage(2);
                        myImgSrc = response.myImgSrc;
                        myId = response.myId;
                        myRanking = response.myRanking;
                        ...
                        if (rankBeans.size()>0){
                            ...
                            champion = new RankBean();
                            champion.setName(myName);
                            champion.setImgSrc(myImgSrc);
                            champion.setUid(myId);
                            champion.setRanking(myRanking);
                        }
                        ...
                        String k_frag_siteUrl = "http://m."+Constant.IYBHttpHead()+"/i/getRanking.jsp?uid=" + uid + "&appId=" + Constant.APPID + "&sign=" + MD5.getMD5ofStr(uid + "ranking" + Constant.APPID)
            ...
            case "学习":
                ...
                ExeProtocol.exe(new GetRankStudyInfoRequest(uid, type, start, total, modes), new ProtocolResponse() {
                    ...
                    public void finish(BaseHttpResponse bhr) {
                        ...
                        String x_frag_siteUrl = "http://m."+Constant.IYBHttpHead()+"/i/getRanking.jsp?uid=" + uid + "&appId=" + Constant.APPID + "&sign=" + MD5.getMD5ofStr(uid + "ranking" + Constant.APPID)
            ...
            case "测试":
                ...
                ExeProtocol.exe(new GetRankTestInfoRequest(uid, type, start, total), new ProtocolResponse() {
                    ...
                    public void finish(BaseHttpResponse bhr) {
                        ...
                        frag_siteUrl = "http://m."+Constant.IYBHttpHead()+"/i/getRanking.jsp?uid=" + uid + "&appId=" + Constant.APPID + "&sign=" + MD5.getMD5ofStr(uid + "ranking" + Constant.APPID)
    ...
    private void setInfo() {
        ...
        switch (rankType) {
            case "阅读":
                ...
                break;
            case "听力":
                userInfo.setText(Integer.valueOf(myTotalTime)/60 + "分钟，文章数: " + myTotalEssay + "，单词数: " + myTotalWord + "，排名: " + myRanking);
                break;
            case "口语":
                double scores_avg = 0;
                if (myCount.equals("0")) {
