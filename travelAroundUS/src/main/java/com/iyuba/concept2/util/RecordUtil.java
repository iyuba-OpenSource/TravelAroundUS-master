...
import com.iyuba.concept2.sqlite.mode.WaveHeader;
...
//        if (mp3FilePath.substring(mp3FilePath.length()-4,mp3FilePath.length()).equals(".wav")) {
//            wav2mp3(mp3FilePath.replace(".mp3", ".wav"));
//        }else {
//            Log.e("mp3FilePath",mp3FilePath);
//        }
        wav2mp3(mp3FilePath.replace(".mp3", ".wav"));
    }
