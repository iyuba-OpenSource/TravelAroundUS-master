...
//        String sign = URLEncoder.encode(uid + type + start + total + date);
        ...
        setAbsoluteURI("http://daxue."+Constant.IYBHttpHead()+"/ecollege/getTopicRanking.jsp?uid=" +
                uid +
                "&type=" +
                type +
                "&start=" +
                ...
                "&shuoshuotype=" +
                shuoshuotype);
        Log.e("GetRankSpeakInfoRequest", "http://daxue."+Constant.IYBHttpHead()+"/ecollege/getTopicRanking.jsp?uid=" +
                uid +
                "&type=" +
                type +
                "&start=" +
