...
//        String sign = URLEncoder.encode(uid + type + start + total + date);
        ...
        setAbsoluteURI("http://cms."+Constant.IYBHttpHead()+"/newsApi/getNewsRanking.jsp?uid=" +
                uid +
                "&type=" +
                type +
                "&start=" +
                ...
                "&sign=" +
                sign );
        Log.e("GetRankReadInfoRequest", "http://cms."+Constant.IYBHttpHead()+"/newsApi/getNewsRanking.jsp?uid=" +
                uid +
                "&type=" +
                type +
                "&start=" +
