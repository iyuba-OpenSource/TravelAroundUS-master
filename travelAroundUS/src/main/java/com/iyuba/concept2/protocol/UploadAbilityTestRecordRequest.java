...
public class UploadAbilityTestRecordRequest implements GetResponse {
    private MediaType JSON = MediaType.parse("application/json; charset=utf-8");
    public String responseString = "";

    public UploadAbilityTestRecordRequest(String jsonStr) {
        // super();
        String requestUrl = "http://daxue."+Constant.IYBHttpHead()+"/ecollege/updateExamRecord.jsp";
