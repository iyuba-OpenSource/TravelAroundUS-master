...
import com.iyuba.concept2.sqlite.op.VoaStructureExerciseOp;
 ...
 * 关键句型习题
 */
public class VoaStructureExerciseActivity extends BasisActivity {
    public static VoaStructureExerciseActivity instance;

    private Map<Integer, VoaStructureExercise> structureMap;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.voa_structure_exercise);
...
//                        mContext.startActivity(intent);
    ...
    public void refreshQuestion() {
        ...
        Log.e("questionNumber", structureExercise.quesNum + "");
    ...
    public void judgeUserAnswer() {
        ...
        for (ExerciseRecord record : exerciseRecordMap.values()) {
            ...
            } else if (record.RightAnswer.equals(record.UserAnswer)) {
                record.AnswerResut = 1;
            } else {
