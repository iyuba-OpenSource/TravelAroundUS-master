...
import com.iyuba.concept2.adapter.LsDetailAdapter;
import com.iyuba.concept2.protocol.ListenDetailRequest;
import com.iyuba.concept2.protocol.ListenDetailResponse;
import com.iyuba.concept2.sqlite.mode.ListenWordDetail;
	...
	private class UpdateLsDetailThread extends Thread {
		...
		public void run() {
			...
			ClientSession.Instace().asynGetResponse(
					new ListenDetailRequest(String.valueOf(UserInfoManager.getInstance().getUserId()), String.valueOf(page),
