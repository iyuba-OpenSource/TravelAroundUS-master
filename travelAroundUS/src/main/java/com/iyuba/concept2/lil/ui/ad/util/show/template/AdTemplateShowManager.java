package com.iyuba.concept2.lil.ui.ad.util.show.template;
...
//        }
    ...
    private void showAd(Activity context,String key,int[] showAdArray){
        ...
        OkHttpClient client = new OkHttpClient.Builder()
                ...
                .build();
        IyuNative iyuNative = new IyuNative(context, String.valueOf(Constant.APPID),client);
        ...
        //先计算宽度(屏幕宽度-两侧的边距)
        int adWidth = LibScreenUtil.getScreenW(context);
        //再计算高度(穿山甲文档中显示需要设置高度)
//        int picHeight = (int) (adWidth*0.43);
//        int adHeight = picHeight*7/10;
        int adHeight = LibScreenUtil.dip2px(context,100+2*16);//动态高度有点问题，这里使用固定高度132px
