package com.iyuba.concept2.lil.ui.ad.util.upload;
...
import com.iyuba.concept2.lil.ui.ad.util.upload.submit.AdLocalMarkBean;
import com.iyuba.concept2.lil.ui.ad.util.upload.submit.AdSubmitBean;
...
import com.iyuba.core.lil.model.remote.manager.AdRemoteManager;
...
public class AdUploadManager {
    ...
    /**
     * 点击广告上传
     * @param showType {@link com.iyuba.concept2.lil.ui.ad.util.show.AdShowUtil.NetParam 的AdShowPosition}
     * @param adType {@link com.iyuba.concept2.lil.ui.ad.util.show.AdShowUtil.NetParam 的AdType}
    ...
    public void submitAdMsgData(String packageName, List<AdLocalMarkBean> localAdList, OnAdSubmitCallbackListener onAdSubmitCallbackListener){
        ...
        //设备id
        TelephonyManager manager = (TelephonyManager) ConceptApplication.getContext().getSystemService(Context.TELEPHONY_SERVICE);
